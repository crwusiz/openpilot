...
def create_acc_control(packer, CP, enabled, accel_last, accel, stopping, gas_override, set_speed, CS):
  jerk = 5
  jn = jerk / 50
  ...
  values = {
    ...
    "SET_ME_TMP_64": 0x64,
    "NEW_SIGNAL_10": 4,
    "DISTANCE_SETTING": CruiseStateManager.instance().gapAdjust,
  }
