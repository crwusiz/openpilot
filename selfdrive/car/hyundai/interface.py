...
from openpilot.selfdrive.car.hyundai.values import HyundaiFlags, CAR, DBC, Buttons, CANFD_CAR, EV_CAR, HYBRID_CAR, LEGACY_SAFETY_MODE_CAR, CANFD_RADAR_SCC_CAR
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate == CAR.ELANTRA_I30:
      ...
      ret.wheelbase = 2.80
      ret.steerRatio = 15.2
    elif candidate in [CAR.KONA, CAR.KONA_EV, CAR.KONA_HEV, CAR.KONA_SX2_EV]:
      ret.mass = 1743.
      ret.wheelbase = 2.60
      ret.steerRatio = 13.7
      ret.tireStiffnessFactor = 0.385
