...
# Constants
ALERT_COLORS = {
  AlertStatus.normal: rl.Color(0x15, 0x15, 0x15, 0x64),      # #151515 with alpha 0xF1
  AlertStatus.userPrompt: rl.Color(0xDA, 0x6F, 0x25, 0x64),  # #DA6F25 with alpha 0xF1
  AlertStatus.critical: rl.Color(0xC9, 0x22, 0x31, 0x64),    # #C92231 with alpha 0xF1
}
