...
procs = [
  ...
  NativeProcess("stream_encoderd", "openpilot/system/loggerd", ["./encoderd", "--stream"], or_(livestream, only_onroad)),
  ...
  PythonProcess("webrtcd", "openpilot.system.webrtc.webrtcd", or_(livestream, only_onroad)),
