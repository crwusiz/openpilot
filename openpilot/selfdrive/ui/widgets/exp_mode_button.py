...
class ExperimentalModeButton(Widget):
  ...
  def _get_gradient_colors(self):
    ...
    if self.experimental_mode:
      return colors_alpha(Colors.EXPERIMENTAL_START, alpha), colors_alpha(Colors.EXPERIMENTAL_END, alpha)
    else:
      return colors_alpha(Colors.CHILL_START, alpha), colors_alpha(Colors.CHILL_END, alpha)
